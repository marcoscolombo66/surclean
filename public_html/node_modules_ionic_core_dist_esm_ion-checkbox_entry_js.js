...
const Checkbox = class {
  ...
  render() {
    ...
    const { label, labelId, labelText } = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.d)(el, inputId);
    (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.e)(true, el, name, checked ? value : '', disabled);
    let path = indeterminate ? ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("path", { d: "M6 12L18 12", part: "mark" })) : ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("path", { d: "M5.9,12.5l3.8,3.8l8.8-8.8", part: "mark" }));
    if (mode === 'md') {
      path = indeterminate ? ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("path", { d: "M2 12H22", part: "mark" })) : ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("path", { d: "M1.73,12.91 8.1,19.28 22.79,4.59", part: "mark" }));
    }
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, "aria-labelledby": label ? labelId : null, "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "checkbox", class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_3__.c)(color, {
        [mode]: true,
        ...
        interactive: true,
      }) }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("svg", { class: "checkbox-icon", viewBox: "0 0 24 24", part: "container" }, path), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", { htmlFor: inputId }, labelText), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "checkbox", "aria-checked": `${checked}`, disabled: disabled, id: inputId, onFocus: () => this.onFocus(), onBlur: () => this.onBlur(), ref: (focusEl) => (this.focusEl = focusEl) })));
  }
