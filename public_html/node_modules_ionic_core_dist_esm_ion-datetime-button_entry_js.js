...
const DatetimeButton = class {
  constructor(hostRef) {
     ...
     */
    this.waitForDatetimeChanges = /*#__PURE__*/(0,C_Ionic_surclean_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
      if (!datetimeEl) {
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,C_Ionic_surclean_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
        if (!overlayEl) {
